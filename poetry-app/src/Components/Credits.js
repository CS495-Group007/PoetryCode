                    ...
                    <Container>
                        <Row>
                            <Col>
                                ...
                                <p>Iambic pentameter is the regular pattern of long and short syllables used, from the sixteenth century until today, by poets and playwrights working in English. Learning how to identify the six combinations of syllables that can make up a line of pentameter, called scansion, is key. Poetry, since the <a href="https://hexameter.co/">classical period</a>, was meant to be heard. This game helps you learn, practice, and master the skill of scansion.</p>
                                <h3>Overview</h3>
                                ...
                                <p>Due to the last century’s preference for open forms, the skill known as scanning has begun to disappear from the academy. To help re-seed the disciplines of poetry, classical acting, and literary criticism with the skill of scansion, we propose the development of a web-based mobile application where users can learn and practice the skill of scansion through a gamified, block-learning interface, supporting literary study, theatre practice, and public engagement with poetry.</p>
                                ...
                                <p><b>Tera K. Pate</b> Pate is a doctoral student of English at the University of Alabama, research assistant for <i>SyllaBits</i>, and a member of the <a href="https://strode.english.ua.edu/">Hudson Strode Program in Renaissance Studies</a>.</p>
